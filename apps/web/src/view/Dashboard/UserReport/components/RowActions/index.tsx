...
import { unassignLiveDaysUseCase } from '@useCases/reports/unassignLiveDays'
import { Button, Flex, Modal, message } from 'antd'
import { ILiveDayRow } from 'oitoselo-models'
import { ReactNode, useCallback, useState } from 'react'

type TAction = 'delete' | 'unassign'
...
const BUTTONS: Record<TAction, IButton> = {
    unassign: {
        title: 'Desatribuir',
        icon: <StopOutlined />,
        confirmationMessage: 'Tem certeza que deseja desatribuir esse dia',
        successMessage: 'Dia desatribuido!',
        onClick: (id: number) => unassignLiveDaysUseCase([id]),
    },
    delete: {
        title: 'Excluir',
        icon: <DeleteOutlined />,
